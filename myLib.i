...
void drawRect4(int col, int row, int width, int height, volatile unsigned char colorIndex) {
    ...
    if (!(col & 1) && !(width & 1)) {
        for (int r0 = 0; r0 < height; r0++) {
            DMANow(3, &pixelData, &videoBuffer[((row+r0)*(240)+(col)) / 2], (2 << 23) | width / 2);
        }
        ...
        for (int r1 = 0; r1 < height; r1++) {
            if (width > 1) {
                DMANow(3, &pixelData, &videoBuffer[((row+r1)*(240)+(col)) / 2], (2 << 23) | (width - 1) / 2);
            }
        ...
        for (int r2 = 0; r2 < height; r2++) {
            if (width > 1) {
                DMANow(3, &pixelData, &videoBuffer[((row + r2)*(240)+(col + 1)) / 2], (2 << 23) | (width - 1) / 2);
            }
        ...
        for (int r3 = 0; r3 < height; r3++) {
            if (width > 2) {
                DMANow(3, &pixelData, &videoBuffer[((row + r3)*(240)+(col + 1)) / 2], (2 << 23) | (width - 2) / 2);
            }
